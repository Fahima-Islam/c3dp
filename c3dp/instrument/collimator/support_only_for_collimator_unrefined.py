...
class Collimator_support(object):
    ...
    def set_constraints(self, max_coll_height_detector=250., max_coll_width_detector=250.,
                        ...
                        min_channel_wall_thickness=1.,
                         min_channel_size=3.,
                        detector_dist_fr_sample_center=500.,
                        detector_size=500., collimator_front_end_from_center=16.02,
                        truss_base_thickness=30.,
                        truss_height_factor=10., truss_curvature=1.,
                        trass_final_height_factor=0.77,
                        beam_dist_support=33.,touch_to_halfcircle=0.5,
...
#############################################################################################
 ...
 ########################################################################
    ...
    def support_design(self):
        ...
        vertical_blade = operations.rotate(
            operations.subtract(operations.rotate(shapes.block(height='%s *mm' % (self.max_coll_height_detector),
                                                               width='%s *mm' % (thickness_collimator_at_support_end),
                                                               thickness='%s *mm' % 1), transversal=1,
                                                  angle="%s *degree" % 90),
                                operations.translate(small_pillar_beam_tocut,
                                                     beam='%s*mm' % -(
        ...
        blade3 = operations.translate(pillar_beam3,
                                      beam='%s *mm' % (distance_fr_center_height_main - self.touch_to_halfcircle))
        ...
        blades = [vertical_blade, blade1_needed, blade1_dia, blade2, blade2_dia, blade3, blade3_dia, blade4, blade4_dia,
                  blade5,
                  blade5_dia, blade6, ]
