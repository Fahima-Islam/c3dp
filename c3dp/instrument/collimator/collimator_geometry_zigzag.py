...
def create(coll_front_end_from_center, max_coll_len, Snap_angle=False, vertical_number_channels=20, horizontal_number_channels=20,
    ...
    coll.set_constraints(SNAP_acceptance_angle=Snap_angle,
                         ...
                         max_coll_length=max_coll_len, min_channel_size=3.,
