...
class DAC(object):
    ...
    def __init__(self, culet_angle=82., table_length=2.5, culet_length=2, girdle_height=1.11, girdle_length=6,
        ...
        self.culet_length = culet_length  # mm
        self.girdle_height = girdle_height  # mm
        self.girdle_length = girdle_length  # mm

        self.gasket_diameter = gasket_diameter  # mm
        self.sample_radius = sample_radius  # mm
        self.sample_height = sample_height #0.2 (real height) #1.5  # mm 0.2 mm

        self.seat_bottom_diameter =seat_bottom_diameter  #17.88  # mm
        ...
        self.seat_hollow_large_cone_diameter = seat_hollow_top_diamter # mm #seat_hollow_top_diamter
        self.seat_top_diameter = seat_top_diameter  # mm
        self.seat_hollow_tappered_height = seat_hollow_tappered_height  # mm
        self.seat_skirt_height = seat_skirt_height  # mm
        self.seat_shaft_height = seat_shaft_height  # mm

        self.vision_seat_bottom_diameter = vision_seat_bottom_diameter  # 17.88  # mm
        self.vision_seat_top_diameter = vision_seat_top_diameter #mm
        self.vision_seat_hollow_top_diamter = vision_seat_hollow_top_diamter #mm
        self.vision_seat_hollow_bottom_diameter = vision_seat_hollow_bottom_diameter #mm
        self.vision_seat_skirt_height = vision_seat_skirt_height #mm
        self.vision_seat_skirt_angle = vision_seat_skirt_angle #degree
        self.vision_seat_shaft_height = vision_seat_shaft_height #mm
        self.vision_seat_shaft_diameter = vision_seat_shaft_diameter #mm


        self.piston_chamfer_height = piston_chamfer_height  # mm
        self.piston_chamfer_angle = piston_chamfer_angle  # degree
        self.piston_chamfer_base = piston_chamfer_base  # mm
        self.piston_shaft_height = piston_shaft_height  # mm

        self.body_base = body_base  # mm
        self.hollow_base = hollow_base  # mm
        self.bar_height = bar_height  # mm
