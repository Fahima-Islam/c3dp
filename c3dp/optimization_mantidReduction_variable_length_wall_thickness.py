...
from collimator_geometry_variable_channel_length_blade_thickness import create as create_collimator_geometry, Parameter_error
...
class PresureCell(object):
    ...
    def diffraction_pattern_calculation(self,params=[20, 1]):
    ...
    def collimator_inefficiency(self, params):
        ...
        print ('coll_len,:', params[0] , 'wall_thickness,:', params[1]  ,'collimator_performance: ', (sample_peak_int/cell_peak_int))
