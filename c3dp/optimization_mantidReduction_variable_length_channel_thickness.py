...
from collimator_geometry_variable_channel_length_channel_thickness import create as create_collimator_geometry, Parameter_error
...
class PresureCell(object):
    ...
    def collimator_inefficiency(self, params):
        ...
        print ('coll_len,:', params[0] , 'channel_gap,:', params[1]  ,'collimator_performance: ', (sample_peak_int/cell_peak_int))
