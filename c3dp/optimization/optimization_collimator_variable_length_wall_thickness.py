...
class Collimators(Base):
    ...
    def create_collimator_geometry(self, params):
        """
        creating the collimator geometry with variable length and variable wall thickness
        Parameters
        ----------
        params: list of two floats
            parameters for collimator length and variable wall thickness
        ...
        if  self.coll_sim:
            ...
            create_collimator_geometry(
                ...
                min_channel_wall_thickness = wall_size,
            ...
            name = "length_%s-dist_%s" % (max_coll_len, wall_size)
