...
from c3dp.collimator.collimator_geometry import create as create_collimator_geometry, Parameter_error
import reduction
...
def diffraction_pattern_calculation(params):
    ...
    run_script.run_mpi(
        DEFAULT_INSTRUMENT_CONFIGURATION, simdir, beam=scattered, ncount=ncount, nodes=nodes, sample=sample,
